...
class RoomFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $pieceOfFurnitureCategories = [
            ...
            ["Guéridon", "Table 2-4 personnes", "Table 6-8 personnes", "Table monastère", "Table Pliante", "Table Ronde", "Table Basse"],
            ["Halogène", "Lampe abat-jour", "Lustre"],
            ["Aquarium", "Miroir", "Tableau / Cadre", "Tapis"],
            ["Armoire 1 porte", "Armoire 2 Portes", "Armoire 3 Portes", "Armoire dressing", "Bar", "Bibliothèque", "Bibliothèque Lourde", "Buffet bas", "Buffet 2 corps", "Commode"],
            ...
            ["Chauffeuse", "Lit 1 place", "Lit 2 places", "Lit bébé", "Lit Mezzanine", "Matelas"],
            ["Rat empaillé"],
        ];
